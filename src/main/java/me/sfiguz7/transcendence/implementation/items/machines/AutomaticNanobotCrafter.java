...
public abstract class AutomaticNanobotCrafter extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
    ...
    public AutomaticNanobotCrafter(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(category, item, recipeType, recipe);

        new BlockMenuPreset(getID(), "&6Automatic Nanobot Crafter") {
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                AutomaticNanobotCrafter.this.tick(b, false);
            }
    ...
    private void testInputAgainstRecipes(Block block, String input) {
        ...
        ItemStack output = TranscEndencePlugin.getRegistry().getAutomaticNanobotCrafterRecipes().get(input);
